...
import org.apache.activemq.artemis.wildfly.integration.fake.DummyTransactionManager;
import org.apache.activemq.artemis.wildfly.integration.recovery.WildFlyActiveMQRecoveryRegistry;
...
public class WildFlyRecoveryRegistryTest extends ActiveMQRAClusteredTestBase
{
   ...
   {
      System.setProperty("java.naming.factory.initial", "org.apache.activemq.artemis.wildfly.integration.fake.DummyInitialContext");
